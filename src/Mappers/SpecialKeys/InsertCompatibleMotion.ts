...
export class SpecialKeyInsertCompatibleMotion extends GenericMapper implements SpecialKeyCommon {
  indicator = "{safe+motion}";

  private conflictRegExp = /^[0]|\{char\}$/;

  private maps: MotionMap[] = [
    { keys: "safe+q", motionGenerators: [MotionParagraph.prev] },
    { keys: "safe+Q", motionGenerators: [MotionParagraph.next] },

    { keys: "safe+«", motionGenerators: [MotionParagraph.prevWithIndentation, MotionLine.firstNonBlank] },
    { keys: "safe+»", motionGenerators: [MotionParagraph.nextWithIndentation, MotionLine.firstNonBlank] },

    { keys: "safe+“", motionGenerators: [MotionParagraph.nextIndentationLevelDown, MotionLine.firstNonBlank] },
    { keys: "safe+„", motionGenerators: [MotionParagraph.previousIndentationLevelUp, MotionLine.firstNonBlank] },

    { keys: "safe+‘", motionGenerators: [MotionParagraph.nextIndentationLevelUp, MotionLine.firstNonBlank] },
    { keys: "safe+’", motionGenerators: [MotionParagraph.previousIndentationLevelDown, MotionLine.firstNonBlank] },
  ];
